    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('auth-slider/save') ?>" method="post" id="form-save" enctype="multipart/form-data">
                    <div class="form-group mb-3">
                        <div class="text-center">
                            <img src="<?= base_url('file?file=/master/default.png') ?>" class="w-75 img-preview" alt="">
                        </div>
                        <div class=" mt-3">
