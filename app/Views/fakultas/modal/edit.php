    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('fakultas/' . $fakultas['fk_id'] . '/update') ?>" method="post" id="form-save" enctype="multipart/form-data">
                    <div class="form-group mt-2">
                        <label for="fk_id">Kode Fakultas</label>
                        <div class="input-group mb-3">
                            <input type="text" name="fk_id" id="fk_id" class="form-control" value="<?= htmlspecialchars($fakultas['fk_id'], ENT_QUOTES, 'UTF-8') ?>">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="text" name="fk_nama" id="fk_nama" class="form-control" value="<?= htmlspecialchars($fakultas['fk_nama'], ENT_QUOTES, 'UTF-8') ?>">
