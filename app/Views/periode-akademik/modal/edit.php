    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form
                    action="<?= base_url('periode-akademik/'.$periode_akademik['prd_akd_id'].'/update') ?>"
                    method="post"
                    id="form-save"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <select
                                        ...
                                        <?php
                                            $tahun = explode('/', $periode_akademik['prd_akd_tahun']);
                                            $currentYear = date("Y");
                                            for ($year = 2015; $year <= $currentYear + 1; $year++) {
                                                echo "<option value=\"$year\" ".($year ==  $tahun[0] ? "selected" : "").">$year</option>";
                                            }
                                            ?>
                                    </select>
                                    ...
                                    <div class="input-group-append">
                                        <span class="input-group-text font-weight-bold">/
                                            <span id="input-group-tahun-2" class="ml-2"><?= $tahun[1] ?></span></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="prd_akd_semester" id="prd_akd_semester" class="form-control">
                                    <option value="1" <?= $periode_akademik['prd_akd_semester'] == 1 ? 'selected' : '' ?>>Ganjil</option>
                                    <option value="2" <?= $periode_akademik['prd_akd_semester'] == 2 ? 'selected' : '' ?>>Genap</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="prd_akd_expired" class="col-sm-3 col-form-label">Masa Aktif</label>
                        <div class="col-sm-9">
                            <input
                                type="date"
                                class="form-control"
                                id="prd_akd_expired"
                                name="prd_akd_expired" value="<?= $periode_akademik['prd_akd_expired'] ?>">
