    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('ruang-kelas/' . $ruangKelas['rk_id'] . '/update') ?>" method="post" id="form-save" enctype="multipart/form-data">
                    <div class="form-group mt-2">
                        <label for="rk_label">Label Ruang Kelas</label>
                        <div class="input-group mb-3">
                            <input type="text" name="rk_label" id="rk_label" class="form-control" value="<?= htmlspecialchars($ruangKelas['rk_label'], ENT_QUOTES, 'UTF-8') ?>">
                    ...
                    <div class="form-group mt-2">
                        ...
                        <input type="text" name="rk_lokasi" id="rk_lokasi" class="form-control" value="<?= htmlspecialchars($ruangKelas['rk_lokasi'], ENT_QUOTES, 'UTF-8') ?>">
