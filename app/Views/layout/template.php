                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown navbar-notifikasi">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <?php if ($groupList = json_decode(session()->get('userGroupList'), true)) : ?>
                            <?php foreach ($groupList as $userGroup) : ?>
                                <a class="dropdown-item"
                                    href="<?= base_url('move-group/' . $userGroup['grp_id'] . '/') ?>">
                                    <?= $userGroup['grp_nama'] ?>
                                    <?= session()->get('userGroup') == $userGroup['grp_label'] ? '<i class="fas fa-check-square text-success"></i>' : '' ?>
                                </a>
                            <?php endforeach ?>
                        <?php endif; ?>
                        </div>
