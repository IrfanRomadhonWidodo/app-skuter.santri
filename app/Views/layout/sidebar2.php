    ...
    <div class="sidebar">
        <nav>
            <ul
                ...
                <li class="nav-item">
                    <a
                        href="<?= base_url('pembayaran-spp') ?>"
                        class="nav-link <?= $uri_1 == 'pembayaran-spp' ? 'active' : '' ?>">
                ...
                <li class="nav-item <?= $uri_1 == '' ? 'menu-open' : '' ?> ">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            ...
                            <a href="<?= base_url('kas-kecil') ?>" class="nav-link <?= $uri_1 == 'kas-kecil' && $uri_2 == null ? 'active' : '' ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Kas Kecil</p>
                            </a>
                        </li>
                ...
                <li class="nav-item <?= $uri_1 == '' ? 'menu-open' : '' ?> ">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            ...
                            <a href="<?= base_url('penggajian-staff') ?>" class="nav-link <?= $uri_1 == 'penggajian-staff' && $uri_2 == null ? 'active' : '' ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Staff</p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item <?= $uri_1 == '' ? 'menu-open' : '' ?> ">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    ...
                                    <a href="<?= base_url('laporan-pasiva') ?>" class="nav-link <?= $uri_1 == 'laporan-pasiva' && $uri_2 == null ? 'active' : '' ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Pasiva</p>
                                    </a>
                                </li>
