    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('set-nilai/save') ?>" method="post" id="form-save" enctype="multipart/form-data">
                    <div class="form-group mt-2">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="stn_nilai_huruf">Nilai Huruf</label>
                                    <input type="text" name="stn_nilai_huruf" id="stn_nilai_huruf" class="form-control">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="stn_bobot" id="stn_bobot" class="form-control" step="0.01">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="stn_dari" id="stn_dari" class="form-control">
                                ...
                                <div class="col-md-6">
                                    <label for="stn_sampai">Sampai (<=) </label>
                                            <input type="number" name="stn_sampai" id="stn_sampai" class="form-control">
