                ...
                <form
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="jbtn_id" id="jbtn_id" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <select name="jbtn_unkj_id" id="jbtn_unkj_id" class="form-control">
                            ...
                            <option value="<?= $value['unkj_id'] ?>"><?= $value['unkj_nama'] ?></option>
                            <?php endforeach ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="jbtn_nama" id="jbtn_nama" class="form-control">
