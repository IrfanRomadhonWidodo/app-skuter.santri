...
class UserDosen extends BaseController
{
    protected $userModel;
    ...
    {
        $this->breadcrumb->add('Dosen', '/');

        $data = [
            'title' => getenv('app.name').' - User Dosen',
            'page'  => 'Data Dosen',
    ...
    {
        $this->breadcrumb->add('Dosen', '/dosen');
        $this->breadcrumb->add('Tambah', '/');

        $data = [
            'title' => getenv('app.name').' - Tambah Dosen',
            'page'  => 'Tambah Dosen',
            'breadcrumbs' => $this->breadcrumb->render(),
        ...
        return view('user-dosen/create', $data);
    }
