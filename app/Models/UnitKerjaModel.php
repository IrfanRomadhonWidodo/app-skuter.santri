...
{
    protected $table            = 'tbl_md_unit_kerja';
    protected $primaryKey       = 'unkj_id';
    protected $returnType       = 'array';
    protected $useSoftDeletes   = false;
    protected $protectFields    = false;

    // Dates
    protected $createdField  = 'unkj_created_at';
    protected $updatedField  = 'unkj_updated_at';

    var $order = ['tbl_md_unit_kerja.unkj_created_at', 'DESC'];
