...
class ConfigAuthSliderModel extends Model
{
    protected $table            = 'tbl_cf_auth_slider';
    protected $primaryKey       = 'auth_slider_id';
    protected $returnType       = 'array';
    protected $protectFields    = false;

    var $order = ['tbl_cf_auth_slider.auth_slider_id', 'DESC'];
