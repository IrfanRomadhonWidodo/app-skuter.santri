...
{
    protected $table            = 'tbl_md_ruang_kelas';
    ...
    protected $createdField  = 'rk_created_at';
    protected $updatedField  = 'rk_updated_at';

    var $order = ['tbl_md_ruang_kelas.rk_created_at', 'DESC'];
