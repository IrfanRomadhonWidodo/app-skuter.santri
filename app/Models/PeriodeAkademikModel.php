...
{
    protected $table            = 'tbl_md_periode_akademik';
    protected $primaryKey       = 'prd_akd_id';
    ...
    protected $createdField  = 'prd_akd_created_at';
    protected $updatedField  = 'prd_akd_updated_at';
