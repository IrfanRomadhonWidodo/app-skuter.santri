    ...
    "columns": [
        {
            ...
            "data": "cust_nama",
            "render" : function (data, type, row, meta) {
                return data + '<br>' + '<span class="badge badge-primary">' + row.trs_cust_id + '</span>';
            }
        }, {
            "data": "cust_nomor_hp",
        }, {
            "data": "trs_nomor_faktur"
        }, {
            "data": "trs_tanggal"
        }, {
            "data": "trs_nominal",
            "render" : function (data, type, row, meta) {
                return convertRupiah(parseInt(data).toString()  , 'Rp ');
            }
        }, {
            "data": "trs_poin"
        }, {
...
function btnDelete(id) {
    Swal
        .fire({
            text: "Apakah anda yakin akan menghapus poin ini?",
            icon: 'warning',
