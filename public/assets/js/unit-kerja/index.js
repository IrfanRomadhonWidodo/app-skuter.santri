...
table = null;
table = $('#table-unit-kerja').DataTable({
    "processing": true, "serverSide": true, "ordering": true,
    "scrollX": true,
    "ajax": {
        "url": $('#table-unit-kerja').data('url'),
        "type": $('#table-unit-kerja').data('method'),
        "data": function(d){
    ...
    "columns": [
        {
            ...
            "sortable": false,
            "render": function (data, type, row, meta) {
                let btnEdit = `<button class="btn btn-success btn-sm mb-1 mr-1" data-url="${base_url() + 'unit-kerja/' + data + '/modal-edit'}"
                ...
                let btnDelete = `<button class="btn btn-danger btn-sm mb-1 mr-1" data-url="${base_url() + 'unit-kerja/' +
                        data + '/delete'}"
