...
function resetForm() {
    $(
        ...
        'r_email, #usr_id, #usr_dsn_npp, #usr_dsn_nik'
    ).val('')
    ...
    $('#usr_dsn_prodi_id option:first').prop('selected', true);
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (resp['error']) {
                ...
                if (resp['error']['usr_dsn_prodi_id']) {
                    $('#usr_dsn_prodi_id').addClass('is-invalid');
                    $('.errorusr_dsn_prodi_id').html(resp['error']['usr_dsn_prodi_id']);
                } else {
                    $('#usr_dsn_prodi_id').removeClass('is-invalid');
                }
                ...
                if (resp['error']['usr_dsn_npp']) {
                    $('#usr_dsn_npp').addClass('is-invalid');
                    $('.errorusr_dsn_npp').html(resp['error']['usr_dsn_npp']);
                } else {
                    $('#usr_dsn_npp').removeClass('is-invalid');
                }
                if (resp['error']['usr_dsn_nik']) {
                    $('#usr_dsn_nik').addClass('is-invalid');
                    $('.errorusr_dsn_nik').html(resp['error']['usr_dsn_nik']);
                } else {
                    $('#usr_dsn_nik').removeClass('is-invalid');
                }
                return false;
            }
